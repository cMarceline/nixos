{ lib, pkgs, config, ... }: {
  ...
  services.persistent-evdev.devices = {
    persist-mouse0 = "/dev/input/by-id/usb-Logitech_USB_Receiver-if02-mouse";
    persist-mouse1 = "/dev/input/by-id/usb-Logitech_USB_Receiver-if02-event-mouse";
    persist-mouse2 = "/dev/input/by-id/usb-Keychron_Keychron_C1-if01-mouse";
    persist-mouse3 = "/dev/input/by-id/usb-Keychron_Keychron_C1-if01-event-mouse";
    persist-keyboard0 = "/dev/input/by-id/usb-Keychron_Keychron_C1-event-kbd";
  };
